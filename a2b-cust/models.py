...
class CampaignconfCardgroup(models.Model):
...
class Card(models.Model):
    ...
    useralias = models.CharField(unique=True, max_length=150)
...
class CardgroupService(models.Model):
    id_card_group = models.IntegerField(primary_key=True)
...
class DidDestination(models.Model):
    id = models.IntegerField(primary_key=True)
...
class EpaymentLog(models.Model):
    id = models.IntegerField(primary_key=True)
...
class EpaymentLogAgent(models.Model):
    id = models.IntegerField(primary_key=True)
...
class InvoiceConf(models.Model):
    id = models.IntegerField(primary_key=True)
...
class LogpaymentAgent(models.Model):
    id = models.IntegerField(primary_key=True)
    date = models.DateTimeField()
    payment = models.DecimalField(max_digits=17, decimal_places=5)
    agent_id = models.IntegerField()
...
class LogrefillAgent(models.Model):
    id = models.IntegerField(primary_key=True)
    date = models.DateTimeField()
    credit = models.DecimalField(max_digits=17, decimal_places=5)
    agent_id = models.IntegerField()
...
class OutboundCidGroup(models.Model):
    id = models.IntegerField(primary_key=True)
    creationdate = models.DateTimeField()
...
class OutboundCidList(models.Model):
    id = models.IntegerField(primary_key=True)
...
class PackgroupPackage(models.Model):
...
class PaymentsAgent(models.Model):
    id = models.IntegerField(primary_key=True)
    agent_id = models.IntegerField()
...
class RestrictedPhonenumber(models.Model):
    id = models.IntegerField(primary_key=True)
...
class SupportComponent(models.Model):
    id = models.IntegerField(primary_key=True)
...
class TariffgroupPlan(models.Model):
